...
country_codes <- c("ALB", "AND", "AUT", "BEL", "BGR", "BIH", "BLR", "CHE", "CZE", 
"DEU", "DNK", "ESP", "EST", "FIN", "FRA", "FRO", "GBR", "GRC", 
    ...
    onEachFeature: function(feature, layer) {
      layer.on({
        mouseover: function(e) {
          ...
          let layerColour;
          if (data_colour[feature.properties.adm0_a3]) {
            layerColour = data_colour[feature.properties.adm0_a3];
          } else {
            layerColour = '#ffff00'
          }
