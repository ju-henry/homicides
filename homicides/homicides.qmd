...
// Add the GeoJSON layer with hover functionality
  L.geoJSON(europeData, {
    style: function(feature) {
      ...
      const countryValue = data_h[countryName] || -1;
      let countryColour = '#ffff00';
      
      if (countryValue >= 0 && countryValue <= 0.2) {
    ...
    onEachFeature: function(feature, layer) {
      layer.on({
        mouseover: function(e) {
          ...
          const countryName = feature.properties.adm0_a3;
          const countryValue = data_h[countryName] || 'no data';
          const countryLabel = feature.properties.sovereignt + " : " + countryValue;
